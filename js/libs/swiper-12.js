  ...
  function R({ swiper: e, runCallbacks: t, direction: s, step: a }) {
    ...
    (n || (n = i > r ? "next" : i < r ? "prev" : "reset"),
      ...
      t && "reset" === n
        ...
        : t && i !== r && (e.emit(`slideChangeTransition${a}`), "next" === n ? e.emit(`slideNextTransition${a}`) : e.emit(`slidePrevTransition${a}`)));
  }
  var V = {
  ...
  const be = [
      ...
      function o(t) {
        ...
        if (
          ...
          (n.activeElement.isContentEditable ||
            (n.activeElement.nodeName && ("input" === n.activeElement.nodeName.toLowerCase() || "textarea" === n.activeElement.nodeName.toLowerCase())))
        )
          return;
        ...
        (e.isHorizontal()
          ...
          : ((d || c || m || h) && (a.preventDefault ? a.preventDefault() : (a.returnValue = !1)), (c || h) && e.slideNext(f), (d || m) && e.slidePrev(f)),
          i("keyPress", r));
      }
      function d() {
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: a }) {
      ...
      function d() {
        ...
        if (
          ((e.params.navigation = le(e, e.originalParams.navigation, e.params.navigation, { nextEl: "swiper-button-next", prevEl: "swiper-button-prev" })),
          !t.nextEl && !t.prevEl)
        )
          return;
        let s = i(t.nextEl),
          ...
          if (
            ...
            a.forEach((t) => {
              ...
              (a === i ? t.classList.add(...s.bulletActiveClass.split(" ")) : e.isElement && t.setAttribute("part", "bullet"),
                s.dynamicBullets &&
                  (a >= l && a <= p && t.classList.add(...`${s.bulletActiveClass}-main`.split(" ")), a === l && o(t, "prev"), a === p && o(t, "next")));
            });
          else {
            const t = a[i];
            if (
      ...
      (t({ controller: { control: void 0, inverse: !1, by: "slide" } }),
        ...
        s("beforeInit", () => {
          if ("undefined" != typeof window && ("string" == typeof e.params.controller.control || e.params.controller.control instanceof HTMLElement)) {
            return void (
              "string" == typeof e.params.controller.control ? [...document.querySelectorAll(e.params.controller.control)] : [e.params.controller.control]
            ).forEach((t) => {
      ...
      function g(t) {
        ...
        if (
          ...
          if (e.navigation && e.navigation.prevEl && e.navigation.nextEl) {
            ...
            (M(e.navigation.nextEl).includes(a) && ((e.isEnd && !e.params.loop) || e.slideNext(), e.isEnd ? o(s.lastSlideMessage) : o(s.nextSlideMessage)),
          ...
          e.params.a11y.enabled &&
            (function () {
              ...
              (a().removeEventListener("visibilitychange", T),
                e.el &&
                  "string" != typeof e.el &&
                  (e.el.removeEventListener("focus", C, !0), e.el.removeEventListener("pointerdown", x, !0), e.el.removeEventListener("pointerup", S, !0)));
            })();
        }));
    },
    function ({ swiper: e, extendParams: t, on: s }) {
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      const l = () => {
        ...
        return (
          "string" == typeof t && t.indexOf("%") >= 0 ? (t = (parseFloat(t.replace("%", "")) / 100) * e.size) : "string" == typeof t && (t = parseFloat(t)),
          t
        );
      };
      (s("init", () => {
    ...
    function ({ swiper: e }) {
      Object.assign(e, { appendSlide: ce.bind(e), prependSlide: pe.bind(e), addSlide: ue.bind(e), removeSlide: me.bind(e), removeAllSlides: he.bind(e) });
    },
    function ({ swiper: e, extendParams: t, on: s }) {
